...
public class OptionsState extends State{
    ...
    protected void handleInput() {
        ...
        if (Gdx.input.justTouched()) {
            if (back.within(x, y)){
                ...
                RainyEggsGame.music.setVolume(0.1f);
            }
            else if(off.within(x, y)){
                scores.putBoolean("music", true);
                RainyEggsGame.music.setVolume(0.0f);
            }
    ...
    public void render(SpriteBatch sb) {
        ...
        font2.draw(sb, "OPTIONS",RainyEggsGame.WIDTH / 2 , RainyEggsGame.HEIGHT * 15 / 16, Align.center, Align.center, true);
        ...
        font.draw(sb, "SOUND", RainyEggsGame.WIDTH / 2, RainyEggsGame.HEIGHT * 13 / 16, Align.center, Align.center, true);
        font.draw(sb, "CHARACTER", RainyEggsGame.WIDTH / 2, RainyEggsGame.HEIGHT * 9 / 16, Align.center, Align.center, true);
        sb.end();
